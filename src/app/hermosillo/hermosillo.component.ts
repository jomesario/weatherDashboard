...
@Component({
  ...
  templateUrl: './hermosillo.component.html',
  styleUrls: ['./hermosillo.component.css']
})
export class HermosilloComponent implements OnInit {
  lat: number = 29.072967;
  lon: number = -110.955919;
  ...
  /**
   * This function makes an Http Request GET to get the forecast for the next
