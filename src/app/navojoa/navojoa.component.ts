...
@Component({
  selector: 'app-navojoa',
  templateUrl: './navojoa.component.html',
  styleUrls: ['./navojoa.component.css']
})
export class NavojoaComponent implements OnInit {
  lat:number=27.072757;
  lon:number=-109.443749;
